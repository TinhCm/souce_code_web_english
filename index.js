...
var gop_y_input1 = $('.gop_y2_cmt');
var danhGia_button = $('.danhGia_button');
var header_thong_tin_user_1 = $('#header-thong_tin_user_1');
...
header_thong_tin_menu.onclick = function() {
    ...
    gop_y_input1.classList.add('opacity');
    danhGia_button.classList.add('opacity');
}
...
header_thong_tin_menu1b.onclick = function() {
    ...
    gop_y_input1.classList.remove('opacity');
    danhGia_button.classList.remove('opacity');
}
...
header_thong_tin_user_1.onclick = function() {
    window.location.href = '/thong_tin_user/thong_tin.html'
}